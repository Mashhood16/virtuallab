      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 overflow-hidden">
        ...
        <div className="bg-slate-50 rounded-2xl shadow-sm border border-slate-200 flex flex-col overflow-hidden">
          ...
          <div className="p-6 flex-1 overflow-y-auto space-y-6">
            <div>
              ...
              <div className="bg-slate-800 text-green-400 p-3 rounded-lg font-mono text-sm shadow-inner text-center">
            ...
            <div className="flex gap-4">
              ...
              <button 
                ...
                className="py-3 px-4 bg-slate-200 text-slate-700 font-semibold rounded-xl hover:bg-slate-300 flex items-center justify-center"
              >
                <RotateCcw size={20} />
              </button>
            </div>
        ...
        <div className="bg-slate-50 rounded-2xl shadow-sm border border-slate-200 flex flex-col">
          ...
          <div className="p-6 flex-1 flex flex-col items-center justify-between">
            ...
            {/* Dynamic Equation */}
            <div className="w-full bg-slate-800 text-green-400 p-4 rounded-xl font-mono text-center shadow-inner min-h-[4rem] flex flex-col justify-center items-center mt-8">
          ...
          <div className="p-6 flex-1 flex flex-col">
            ...
            <div className="mb-6">
              <div className="flex justify-between items-end mb-2">
                <h3 className="font-semibold text-slate-800">H₂ Volume vs Time</h3>
                <span className="text-xs font-mono bg-slate-100 px-2 py-1 rounded text-slate-600">t = {(time/2).toFixed(1)} s</span>
              </div>
              {renderGraph() || (
                <div className="w-full h-64 bg-slate-50 border border-slate-200 rounded-lg flex items-center justify-center text-slate-400 text-sm">
