      ...
      {tab === 'TLC' && (
       <div className="w-full h-full flex items-center justify-around">
        ...
        <div className="w-32 h-48 bg-slate-50 dark:bg-[#121212] border-2 border-slate-300 dark:border-[#1c1b1b] rounded shadow-inner relative flex justify-around items-end pb-5">
         ...
         {/* Spots */}
         {sample === 'Ethanol' ? (
          <div className={`w-3 h-3 rounded-full bg-blue-500 opacity-80 absolute dark:bg-teal-950/20 dark:border-teal-900 flex-col ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex rounded-t-none lg:rounded-t-xl border-t-0 lg:border-t`} style={{left: '40%', bottom: `${yEthanol}px`}}></div>
         ) : (
