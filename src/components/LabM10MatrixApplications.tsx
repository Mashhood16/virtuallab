          ...
          <div className="bg-fuchsia-50 p-4 rounded-lg border border-fuchsia-100 mb-6">
            ...
            <div className="flex items-center gap-4 mb-4">
              <div className="flex-1">
                <label className="block text-sm font-semibold text-slate-700 mb-1">x value:</label>
                <input 
                  type="number" 
                  value={ansX} 
                  onChange={e => setAnsX(e.target.value)}
                  className="w-full p-2 border border-slate-300 rounded focus:ring-2 focus:ring-fuchsia-500 outline-none"
                  placeholder="e.g. 2.5"
                />
              </div>
              <div className="flex-1">
                <label className="block text-sm font-semibold text-slate-700 mb-1">y value:</label>
                <input 
                  type="number" 
                  value={ansY} 
