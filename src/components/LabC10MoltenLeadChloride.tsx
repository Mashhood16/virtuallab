...
export default function LabC10MoltenLeadChloride({ onExit }: { onExit: () => void }) {
  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 font-sans select-none">
      <header className="bg-fuchsia-600 text-white p-4 flex items-center justify-between shadow-md">
        <div className="flex items-center gap-2">
          <Activity className="w-6 h-6" />
          <h1 className="text-xl font-bold">Electrolysis of Molten PbCl₂</h1>
        </div>
        <button onClick={onExit} className="flex items-center gap-2 px-4 py-2 bg-fuchsia-700 hover:bg-fuchsia-800 rounded-lg transition-colors">
