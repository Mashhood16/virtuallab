...
export default function LabM11Matrices({ onExit }: { onExit?: () => void }) {
 ...
 <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
  ...
  {/* LEFT: Theory & Setup */}
  <div className={`bg-slate-50 dark:bg-[#121212] p-6 rounded-lg shadow flex flex-col gap-4 lg:overflow-y-auto border-t-4 border-indigo-500 ${activeMobileTab === 'theory' ? 'flex' : 'hidden'} lg:flex`}>
  ...
  {/* MIDDLE: Simulator */}
  <div className={`bg-white lg:bg-slate-50 dark:bg-[#121212] lg:dark:bg-[#121212] p-6 rounded-lg shadow flex flex-col items-center justify-center border-t-4 border-fuchsia-500 relative ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex order-first lg:order-none rounded-b-none lg:rounded-b-xl border-b-0 lg:border-b`}>
