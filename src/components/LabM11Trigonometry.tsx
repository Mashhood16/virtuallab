      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
        <div className="bg-slate-50 rounded-xl shadow-sm p-6 border border-slate-200 flex flex-col">
          ...
          <div className="prose prose-slate">
            ...
            <p className="text-center font-mono bg-slate-100 p-2 rounded text-teal-800">
              h(t) = A · sin(B(t - C)) + D
            </p>
        ...
        <div className="bg-slate-50 rounded-xl shadow-sm p-6 border border-slate-200 flex flex-col items-center">
          ...
          <div className="w-full flex justify-center items-center bg-slate-900 rounded-lg p-4 mb-6 relative h-64 overflow-hidden shadow-inner">
            ...
            <div className="absolute top-2 right-2 bg-slate-800/80 px-3 py-1 rounded shadow text-xs font-mono text-teal-400">
              t = {time.toFixed(1)}s
            </div>
            <div className="absolute top-8 right-2 bg-slate-800/80 px-3 py-1 rounded shadow text-xs font-mono text-rose-400">
        ...
        <div className="bg-slate-50 rounded-xl shadow-sm p-6 border border-slate-200 flex flex-col">
          ...
          <div className="mb-6 text-sm text-slate-600">
            ...
            <code className="bg-slate-100 px-2 py-1 rounded text-teal-700 text-base">h(t) = A · sin(B(t)) + D</code>
          </div>
          ...
          <div className="space-y-4 flex-1">
            ...
            <div className="flex flex-col gap-1">
              <label className="text-sm font-medium text-slate-700">Vertical Shift (D)</label>
              <input 
                type="number" 
                value={ansShift}
            ...
            <div className="flex flex-col gap-1">
              <label className="text-sm font-medium text-slate-700">Period (T)</label>
              <input 
                type="number" 
                value={ansPeriod}
