...
export default function LabB11Bioenergetics({ onExit }: { onExit?: () => void }) {
 ...
 <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
  ...
  <div className={`bg-white lg:bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#2a2a2a] lg:dark:border-[#1c1b1b] p-5 flex flex-col items-center justify-center relative ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex order-first lg:order-none rounded-b-none lg:rounded-b-xl border-b-0 lg:border-b`}>
   ...
   {/* Light Source */}
   <div className={`absolute left-4 top-1/2 -translate-y-1/2 w-12 h-16 bg-white lg:bg-slate-700 dark:bg-[#121212] lg:dark:bg-[#121212] rounded-sm border-2 border-slate-500 dark:border-[#2a2a2a] lg:dark:border-[#1c1b1b] flex items-center justify-center flex-col ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex rounded-t-none lg:rounded-t-xl border-t-0 lg:border-t`}>
