                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 flex flex-col">
                    ...
                    {tab === 'solid' && (
                        <div className="flex-grow flex flex-col">
                            <svg viewBox="0 0 400 200" className="w-full bg-slate-50 rounded-lg shadow-inner border mb-2">
                            ...
                            <svg viewBox="0 0 400 200" className="w-full bg-slate-900 rounded-lg shadow-inner border mb-4">
                                {disks3D}
                            </svg>
                            <label className="text-sm font-medium text-slate-700 mb-1">Scale Factor ($k$): {kSolid.toFixed(1)}</label>
                            <input type="range" min="0.5" max="2" step="0.1" value={kSolid} onChange={(e) => setKSolid(Number(e.target.value))} className="mb-2" />
                            <label className="text-sm font-medium text-slate-700 mb-1">Number of Disks ($N$): {nDisks}</label>
                    ...
                    {tab === 'dam' && (
                        <div className="flex-grow flex flex-col">
                            ...
                            <label className="text-sm font-medium text-slate-700 mb-1">Water Depth ($h$): {damH} m</label>
                    ...
                    {tab === 'spring' && (
                        <div className="flex-grow flex flex-col">
                            ...
                            <label className="text-sm font-medium text-slate-700 mb-1">Spring Constant ($k$): {springK} N/m</label>
                            <input type="range" min="10" max="100" step="10" value={springK} onChange={(e) => setSpringK(Number(e.target.value))} className="mb-2" />
                            <label className="text-sm font-medium text-slate-700 mb-1">Stretch Distance ($x$): {springX.toFixed(1)} m</label>
