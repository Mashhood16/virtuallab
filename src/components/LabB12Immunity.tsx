        ...
        <div className="bg-slate-50 p-6 rounded-xl shadow-sm border border-slate-200 flex flex-col items-center relative overflow-hidden">
          ...
          <div className="flex-grow flex flex-col items-center justify-center w-full space-y-6">
            <div className="text-center h-16">
              ...
              <p className="text-sm text-slate-600 max-w-xs">{elisaStages[elisaStep].desc}</p>
            </div>
        ...
        <div className="bg-slate-50 p-6 rounded-xl shadow-sm border border-slate-200 flex flex-col">
          ...
          <div className="flex-grow space-y-6">
            <div className="p-4 bg-slate-100 rounded-lg text-sm text-slate-700">
              <h3 className="font-semibold text-slate-800 mb-2">Determine Antigen Concentration</h3>
              <p className="mb-2">
              ...
              <div>
                ...
                <div className="flex space-x-2">
                  <input 
                    type="number"
                    step="0.01"
                    className="flex-grow p-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                    placeholder="e.g. 5.2"
