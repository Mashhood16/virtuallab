...
export default function LabE9Verbals({ onExit }: { onExit?: () => void }) {
 ...
 <div className="min-h-screen bg-slate-50 dark:bg-[#000000] flex flex-col font-sans">
  ...
  <section className={`bg-white lg:bg-slate-50 dark:bg-[#121212] lg:dark:bg-[#1c1b1b] rounded-xl shadow-sm p-6 border border-slate-200 dark:border-[#2a2a2a] lg:dark:border-[#2a2a2a] flex flex-col h-[calc(100vh-12rem)] lg:h-auto ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex rounded-t-none lg:rounded-t-xl border-t-0 lg:border-t`}>
   ...
   {/* Sorting Controls */}
   <div className={`p-4 rounded-xl border border-slate-200 dark:border-[#2a2a2a] lg:dark:border-[#2a2a2a] flex-col ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex order-first lg:order-none rounded-b-none lg:rounded-b-xl border-b-0 lg:border-b`}>
    <div className="flex items-center justify-between mb-4">
