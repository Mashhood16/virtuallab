      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 flex-1 gap-6 p-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col items-center">
          ...
          <div className="w-full aspect-square max-w-md bg-slate-900 rounded-xl relative overflow-hidden flex items-center justify-center border-4 border-slate-800 shadow-inner">
            ...
            {/* Status Overlay */}
            <div className="absolute top-4 left-4 bg-slate-800/80 text-white text-xs p-2 rounded backdrop-blur border border-slate-700">
          ...
          <div className="w-full mt-6 space-y-4">
            <div>
              <div className="flex justify-between mb-1">
                <label className="text-sm font-semibold text-slate-700">Launch Velocity (v)</label>
            ...
            <div>
              <div className="flex justify-between mb-1">
                <label className="text-sm font-semibold text-slate-700">Launch Altitude (h)</label>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col gap-6 overflow-y-auto">
          ...
          <div className="space-y-6">
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
              <h3 className="font-semibold text-slate-800 mb-2">Task 1: LEO Velocity</h3>
            ...
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
              <h3 className="font-semibold text-slate-800 mb-2">Task 2: Geostationary Altitude</h3>
              <p className="text-sm text-slate-600 mb-3">
