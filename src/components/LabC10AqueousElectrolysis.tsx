        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 flex flex-col gap-6">
          <div>
            ...
            {solutionType === 'conc' ? (
              <div className="bg-slate-100 p-4 rounded-lg font-mono text-sm mb-2 text-slate-700">
                ...
                <div className="mt-2 text-xs text-slate-500">Cl⁻ is in high concentration, so it discharges over OH⁻.</div>
              </div>
            ) : (
              <div className="bg-slate-100 p-4 rounded-lg font-mono text-sm mb-2 text-slate-700">
                ...
                <div className="mt-2 text-xs text-slate-500">Cl⁻ is sparse, so water is oxidized to form Oxygen gas.</div>
              </div>
            )}
          </div>
          ...
          <div className="flex-1">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="text-sm font-medium text-slate-700 mb-2 block">Electrolyte Solution</label>
              ...
              <div>
                <label className="flex justify-between text-sm font-medium text-slate-700 mb-2 mt-4">
                  <span>Voltage</span>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 flex flex-col gap-6 overflow-y-auto">
          <div>
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex gap-2">
                <button onClick={clearLogs} className="text-xs text-slate-500 hover:text-slate-700 px-2">Clear</button>
                <button
                  onClick={recordData}
                  disabled={!isRunning}
