...
export default function LabM11Permutations({ onExit }: { onExit?: () => void }) {
 ...
 return (
  ...
  <div className="flex flex-col lg:grid lg:grid-cols-3 lg:flex-1 lg: overflow-y-auto lg:overflow-visible">
    {/* Left Column: Theory */}
    <div className={`p-6 bg-slate-50 dark:bg-[#121212] border-r border-slate-200 dark:border-[#1c1b1b] lg:overflow-y-auto flex flex-col gap-6 ${activeMobileTab === 'theory' ? 'flex' : 'hidden'} lg:flex`}>
     <div>
