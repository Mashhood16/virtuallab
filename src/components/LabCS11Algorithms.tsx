      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
        <div className="bg-slate-50 rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col">
          ...
          <div className="prose prose-sm text-slate-600 flex-1 overflow-y-auto">
            ...
            <div className="bg-slate-100 p-3 rounded-md mt-4 text-xs font-mono">
          ...
          <div className="flex-1 w-full flex flex-col items-center justify-center">
            ...
            <div className="flex gap-4 mb-6">
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-2 bg-slate-200 text-slate-700 rounded-md font-semibold hover:bg-slate-300 disabled:opacity-50 transition-colors"
              >
                Step Forward
              </button>
              <button
            ...
            <div className="flex gap-8 text-sm font-semibold text-slate-600">
              <div className="bg-slate-100 px-4 py-2 rounded-md">Pass: <span className="text-indigo-600">{sim.i}</span></div>
              <div className="bg-slate-100 px-4 py-2 rounded-md">Comparisons/Swaps: <span className="text-amber-600">{sim.swaps}</span></div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-50 rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col">
          ...
          <div className="flex-1">
            ...
            <div className="mb-4">
              <label className="block text-sm font-semibold text-slate-700 mb-2">Enter the array elements separated by commas:</label>
              <input
                type="text"
                value={ansCode}
                onChange={e => setAnsCode(e.target.value)}
                placeholder="e.g. 10, 20, 30, 40, 50"
                className="w-full px-4 py-2 border border-slate-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none font-mono"
              />
            </div>
