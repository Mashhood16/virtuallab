 ...
 <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
  ...
  <div className={`bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm p-6 flex flex-col items-center border border-slate-200 dark:border-[#1c1b1b] `}>
   ...
   <div className={`relative w-full aspect-square bg-slate-50 dark:bg-[#121212] border rounded-xl overflow- flex flex-col items-center justify-end pb-8 `}>
    ...
    <div className={`w-2 h-2 rounded-full bg-blue-300 absolute top-16 animate-bounce ${activeMobileTab === 'lab' ? 'block' : 'hidden'} lg:block order-first lg:order-none rounded-b-none lg:rounded-b-xl border-b-0 lg:border-b`}></div>
